...
use App\Models\Kost; // Impor model Kost Anda
...
class KostsTableSeeder extends Seeder
{
    ...
    {
        // PENTING: AKTIFKAN INI untuk menghapus data lama setiap kali seeder dijalankan
        Kost::truncate();
        ...
        $kosts = [
            [
                ...
                'images' => json_encode(['kosts/aury.png', 'kosts/bandasakti.png']), // Menggunakan gambar Anda
                'latitude' => -6.917464,
            ...
            [
                ...
                'images' => json_encode(['kosts/putraganesha.png']), // Menggunakan gambar Anda
                'latitude' => -6.890695,
            ...
            [
                ...
                'images' => json_encode(['kosts/bestam.png']), // Menggunakan gambar Anda
            ...
            [
                ...
                'images' => json_encode(['kosts/tubacus.jpg']), // Menggunakan gambar Anda
                'latitude' => 5.170669,
                'longitude' => 97.147775,
            ...
            [
                ...
                'images' => json_encode(['kosts/aury.png']), // Contoh, bisa diganti jika ada gambar kelima
                'latitude' => -6.368688,
             ...
             [
                ...
                'images' => json_encode(['kosts/indah.png']),
                'latitude' => -7.257472,
            ...
            [
                ...
                'images' => json_encode(['kosts/nyaman.png']),
                'latitude' => -7.782806,
            ...
            [
                ...
                'images' => json_encode(['kosts/mewah.png']),
                'latitude' => -6.208763,
